  ...
  render() {
    return (
      <div className="container my-3">
        <h1 className={`text-center text-${this.props.mode==='light'?'dark':'light'}`} style={{margin: '30px 0px', marginTop: '90px'}}>HeadlineHub - Top {this.capitalizeFirstLetter(this.props.category)} Headlines</h1>
