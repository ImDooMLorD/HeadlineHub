  ...
  render() {
    ...
    return (
      <div className="my-3" style={{ position: "relative" }}>
        ...
        <div className="card" style={{ height: "480px", padding: "0", overflow: "hidden", backgroundColor: this.props.mode === 'light' ? 'white' : '#23211c', color: this.props.mode === 'light' ? 'black' : 'white', border: `1px solid ${this.props.mode === 'light' ? 'black' : 'white'}` }}>
